...
<?php
if(  $module->countModules('slideshowshape02')):
?>
<jdoc:include type="modules" name="slideshowshape02" style="<?php if(($module->params->get('slideshowshape02') == 'block') || ($module->params->get('slideshowshape02') == Null)): echo "xhtml"; endif;?>"/>
<?php endif; ?>
</div>
</div>
</li>
