		...
		<div class="twog_extension_wrapper" id="sim_ext_3" roll="3">
			...
			<div class="twog_extension_wrapper_inner">
				<div class="ext_top_wrapper">
					<a href="https://gspeech.io" target="_blank" class="sim_ext_link">GSpeech</a>
					<img  class="sim_img_popular" title="Popular" alt="Popular" src="<?php echo $sim_ext_path;?>jed_status_popular.png" />
				</div>
				<a href="https://gspeech.io" target="_blank" class="sim_ext_link"><img class="sim_ext_img" src="<?php echo $sim_ext_path;?>gspeech.png" /></a>
				<div class="sim_line1">
				...
				<div class="sim_ext_desc">
					Add accessibility to your site and auto-convert content into natural audio in 50+ languages and embed via beautiful audio players.
				</div>
				
				<div class="sim_links">
					<a style="" target="_blank" href="https://gspeech.io/demos" class="creative_btn creative_btn-green creative_btn-mini"><i class="creative_icon-white creative_icon-play"></i> Live Demo</a>
					<a style="" target="_blank" href="https://gspeech.io/docs/connect-to-joomla-website" class="creative_btn creative_btn-red creative_btn-mini"><i class="creative_icon-white creative_icon-download"></i> Download</a>
				</div>
	...
	<div class="sim_ext_item_wrapper">
		<div class="twog_extension_wrapper" id="sim_ext_2" roll="2">
			...
			<div class="twog_extension_wrapper_inner">
				...
				<div class="sim_ext_desc">
					Creative Image Slider is a responsive image slider with amazing visual effects. It is packed with a live-preview wizard to create nice and smooth sliders in a matter of seconds without coding.
				</div>
